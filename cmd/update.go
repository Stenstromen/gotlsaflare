...
func init() {
	...
	updateCmd.Flags().StringP("cert", "f", "", "Path to Certificate File, fullchain if dane-ta is true (Required)")
	...
	updateCmd.Flags().BoolP("dane-ta", "", false, "Create DANE-TA (2 1 1) record")
